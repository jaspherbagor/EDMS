<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/home') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_home') }}"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>

            <li class="nav-item dropdown {{ Request::is('admin/project-list') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-tasks"></i><span>Project</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/project-list') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_project_list') }}"><i class="fas fa-angle-right"></i> All Project</a></li>
                    <li class=""><a class="nav-link" href=""><i class="fas fa-angle-right"></i>Completed Project</a></li>
                    <li class=""><a class="nav-link" href=""><i class="fas fa-angle-right"></i> Ongoing Project</a></li>
                </ul>
            </li>
